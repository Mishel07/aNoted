...
async function sortByCreation(){
    let obj = sessionStorage.getItem("user");
    let res = await getRequest("http://localhost:5000/toDo/sortByCreatedDate",obj);
    console.log(res)
    result=res;
    const div = document.getElementById("cards");
    const childDiv = document.createElement("div");
...
async function sortByModification(){
    let obj = sessionStorage.getItem("user");
    let res = await getRequest("http://localhost:5000/toDo/sortByModifiedDate",obj);
    console.log(res)
    result=res;
    const div = document.getElementById("cards");
    const childDiv = document.createElement("div");
...
async function sortByTitle(){
    let obj = sessionStorage.getItem("user");
    let res = await getRequest("http://localhost:5000/toDo/sortByTitle",obj);
    console.log(res)
    result=res;
    const div = document.getElementById("cards");
    const childDiv = document.createElement("div");
